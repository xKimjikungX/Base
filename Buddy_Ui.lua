do 
    local ui =  game:GetService("CoreGui"):FindFirstChild("Buddy Hub") 
    if ui then
        ui:Destroy()
    end
end
...
function create:Win()
    ...
    Logo.Image = "http://www.roblox.com/asset/?id=71075174554422"
    ...
    getgenv().library.toggledui = false

    function library:ToggleUi()
        if getgenv().library.toggledui == false then
            getgenv().library.toggledui = true  
...
function tap:addtap(text)
    ...
    TextLabel_Tap.Text = " "
    TextLabel_Tap.TextColor3 = Color3.fromRGB(255, 0, 0)
...
function ems:Button(text,callback)
    ...
    emsTextButton.Font = Enum.Font.GothamBold
    ...
    TextLabel_emsTextButton.BackgroundColor3 = Color3.fromRGB(0, 255, 179)
    ...
    TextLabel_emsTextButton.Font = Enum.Font.GothamBold
    TextLabel_emsTextButton.Text = text
    TextLabel_emsTextButton.TextColor3 = Color3.fromRGB(0, 255, 179)
    ...
    MheeFrameStroke.Color = Color3.fromRGB(0, 255, 179)
...
function ems:Button1(text,callback)
    ...
    emsTextButton1.Font = Enum.Font.GothamBold
    emsTextButton1.TextColor3 = Color3.fromRGB(0, 0, 0)
    ...
    TextLabel_emsTextButton1.Font = Enum.Font.GothamBold
    TextLabel_emsTextButton1.Text = text
    TextLabel_emsTextButton1.TextColor3 = Color3.fromRGB(0, 0, 0)
...
function  ems:Toggle(text,de,callback)
    ...
    ToggleButton2.TextColor3 = Color3.fromRGB(5, 3, 3)
    ...
    TextButton_2_Toggle.Font = Enum.Font.GothamBold
    ...
    TextButton_3_Toggle.Font = Enum.Font.GothamBold
    ...
    ImageLabel_Toggle.Image = "http://www.roblox.com/asset/?id=72372949325208"
...
function ems:DropDown(text,text2, default, muti,list,callback)
    ...
    DropFrame.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
    ...
    TextLabelDrop.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
    ...
    FrameDrop.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
    ...
    TextLabelDrop2.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
    ...
    TextLabelDrop2.TextColor3 = Color3.fromRGB(0, 0, 0)
    ...
    TextButton_Dropdown.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
    TextButton_Dropdown.BorderSizePixel = 0
    TextButton_Dropdown.Size = UDim2.new(0, 22, 0, 24)
    TextButton_Dropdown.Font = Enum.Font.GothamBold
    ...
    ListFrame.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
...
function ems:Slder(text,min,max,de,callback)
    ...
    TalabelSlider.Font = Enum.Font.GothamBold
    ...
    MainValue.BackgroundColor3 = Color3.fromRGB(255, 17, 0)
...
function ems:Ti(text)
    ...
    lineframe.Font = Enum.Font.GothamBold
    ...
    lineframe2.Font = Enum.Font.GothamBold
...
function ems:Label(text)
    ...
    Labelxd.Font = Enum.Font.GothamBold
...
function ems:TextBox(text, callback)
    ...
    TextButton_Pageframe_Uiconner.CornerRadius = UDim.new(0, 3)
    TextButton_Pageframe_Uiconner.Name = ""
    TextButton_Pageframe_Uiconner.Parent = TextBoxFrame
